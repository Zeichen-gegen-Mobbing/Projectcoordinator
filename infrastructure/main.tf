...
locals {
  ...
  client_preview_domains      = [for num in range(var.redirect_uris_number, var.redirect_uris_number + 100) : "${local.client_preview_domain_left}-${num}.${client_preview_domain_right}"]
}
