...
public class CustomAuthorizationHeaderMessageHandlerTests : IDisposable
{
...
#pragma warning disable TUnit0023 // Suppress warning about IDisposable - disposed in Dispose method
    protected readonly CustomAuthorizationHeaderMessageHandler _handler;
...
#pragma warning restore TUnit0023
    ...
    public CustomAuthorizationHeaderMessageHandlerTests()
    {
        _handler = new CustomAuthorizationHeaderMessageHandler(_tokenProviderMock.Object, _navigationMock.Object);
    ...
    public class SendAsyncMethod : CustomAuthorizationHeaderMessageHandlerTests
    {
        [Test]
        ...
        {
            // Arrange
            var handler = new CustomAuthorizationHeaderMessageHandler(_tokenProviderMock.Object, _navigationMock.Object);
    ...
    public class ConfigureHandlerMethod : CustomAuthorizationHeaderMessageHandlerTests
    {
        /// <summary>
